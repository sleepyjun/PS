...
첫 번째 해는 <1:1>로 표현되고, 11 번째 해는 <1:11>로 표현된다. 
<3:1>은 13 번째 해를 나타내고, 
...
//일일이 구하는 방법인데 시간초과가 걸린다

/*
10 12 <3 1> 이면

10A+3 = 12B+1 이 되는 해가 있을꺼에요.

0,0 일때 3>1이니까 B를 1증가

0,1일때 3<13이니까 A를 1증가

1,1일때 13=13이니까 이게 해가 됩니다.
*/
